...
WRATH_MOD_VERSION = v1.3

WRATH_VERSION_CODE := FinalEdition
...
WRATH_VERSION := WrathOS-$(WRATH_MOD_VERSION)-$(WRATH_VERSION_CODE)-$(WRATH_EDITION)-$(WRATH_BUILD)-$(WRATH_BUILD_TYPE)-$(WRATH_BUILD_DATE)
WRATH_FINGERPRINT := WrathOS/$(WRATH_MOD_VERSION)/$(WRATH_EDITION)/$(PLATFORM_VERSION)/$(TARGET_PRODUCT_SHORT)/$(WRATH_BUILD_DATE)
WRATH_DISPLAY_VERSION := $(WRATH_MOD_VERSION)|$(WRATH_VERSION_CODE)|$(WRATH_EDITION)|$(WRATH_BUILD_TYPE)
else
WRATH_EDITION := VANILLA
WRATH_BUILD_DATETIME := $(shell date +%s)
WRATH_BUILD_DATE := $(shell date -d @$(WRATH_BUILD_DATETIME) +"%Y%m%d-%H%M%S")
WRATH_VERSION := WrathOS-$(WRATH_MOD_VERSION)-$(WRATH_VERSION_CODE)-$(WRATH_BUILD)-$(WRATH_BUILD_TYPE)-$(WRATH_BUILD_DATE)
WRATH_FINGERPRINT := WrathOS/$(WRATH_MOD_VERSION)/$(PLATFORM_VERSION)/$(TARGET_PRODUCT_SHORT)/$(WRATH_BUILD_DATE)
WRATH_DISPLAY_VERSION :=  $(WRATH_MOD_VERSION)|$(WRATH_VERSION_CODE)|$(WRATH_BUILD_TYPE)
